...
public class Test128
{
	...
	{
		NewCar nCar1 = new NewCar(200, "벤츠", 4);
		NewCar nCar2 = new NewCar(150, "렉서스", 3);
		...
		NewCar nCar3 = nCar1;	//-- 클래스 복사 → 얕은 의미 복사(참조형)
								//	 → 주소값 복사
		...
		System.out.println("4-2 : " + nCar3.hashCode());
		//System.out.println(0x15db9742l);
		//--==>> 4-1 : 366712642
		//		 4-2 : 1829164700
		//		 4-3 : 366712642
