...
○ import 구문
   ...
   ※ JDK 1.5 부터는 import 다음에 『static』 키워드를 붙임으로써
	  ...
	  메소드와 멤버 변수들은 접두사(ex → ob, br, sc 처럼...)을 붙이지 않고
	  사용하는 것이 가능하다.
...
public class Test125	// extends Object
{
	...
	*/
	...
	// default 생성자의 접근제어지시자는 해당 클래스의 접근제어지시자를 따른다.


	public static void main(String[] args)
	{
		Test125 ob = new Test125();
		...
		//--==>> Test125@15db9742 → 자바가 객체를 구분하기 위해 임의로 부여하는 식별번호(주소x!!!!)
		//-- 에러 발생하지 않는 상황
		//	 → toString() 메소드가 Test125 클래스에 존재
		//		→ Object 클래스로부터 상속

		System.out.println(ob);
		//--==>> Test125@15db9742	//-- 이것도 그래서 구체적으로 메커니즘이 어떻게 되는지!!! 질문하기
