...
class DemoImpl1 implements ADemo, BDemo
{
	...
	// JDK 1.5(5.0) 에서도 『@Override』 어노테이션(annotation)을 사용이 가능하다.
	@Override
	public void write()
	{
...
public class Test117
{
	public static void main(String[] args)
	{
		...
		*/
		...
		ADemo ob2 = new DemoImpl1();		//-- 업 캐스팅
		BDemo ob3 = new DemoImpl1();		//-- 업 캐스팅
