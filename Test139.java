...
○ 생성자
   - 원형
	 ...
	 StringTokenizer(String str, String delim, boolen returnDelims)
	 → 주어진 문자열 str 을 단어로 분리하는 객체를 생성하며
	    공백(구분) 문자는 delim 에 포함된 문자로 처리하게 된다.
	    만약 returnDelims 가 true 라면 구분문자도 분리된 데이터로 처리하게 된다.
...
public class Test139
{
	public static void main(String[] args) throws IOException
	{
		...
		n=0;
		while (st.hasMoreTokens())	// true, false 남아있는 토큰이 더 있니 없니
		{
		...
		//--==>>
		/*
		파싱할 문자열 입력(컴마구분) : 사과 고구마 바나나
		파싱된 토큰(문자열) : 사과 고구마 바나나
		계속하려면 아무 키나 누르십시오 . . .
		*/
