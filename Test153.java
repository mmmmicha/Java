...
○ 자료 구조
   ...
   이용에 대한 방법 등의 개념을 이해하여 프로그램에 사용하고
...
○ 컬렉션 프레임워크(Collection Framework)
   ...
   1. 인터페이스(Interface)
	  ...
	  예를 들어, list 는 추가, 제거, 검색 등의 기능을 제공하는
	  컬렉션 인터페이스가 존재하며
...
public class Test153
{
	...
	{
		// Stack 자료구조 생성
		Stack<Object> myStack = new Stack<Object>();	// object라는 애들을 담을 것이다. -- 제네릭 표현식
		...
		String val1 = (String)myStack.peek();		//-- 형 변환 필수~!!! (Object로 반환하기 때문에)
		...
		{
			// pop() : 스택 맨위의 객체 반환. 제거 한다.
			value = (String)myStack.pop(); // 종범 소원 동현 초롱
