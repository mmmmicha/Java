...
==> 개발자가 이런 예외 사항이 발생할 경우를 미리 예측하여
    적절히 대응하기 위한 절차를 구현한도록 문법을 정리해 놓은 것.
	예.외.처.리
	...
	public static void main(String[] args) // throws IOException
	{
		...
		*/
		...
		catch (NumberFormatException e2)
		{
			...
			System.out.println("숫자 형태의 데이터를 입력해~!!!!!");
			//--==>> 첫 번째 정수 입력 : wjd
			//		 java.lang.NumberFormatException: For input string: "wjd"
			//		 숫자 형태의 데이터를 입력해~!!!!!
			//		 계속하려면 아무 키나 누르십시오 . . .
		...
		*/
		...
		{
			// Exception 의 인스턴스는 따로 생성하지 않아도 main()메소드가 만들어
			System.out.println(e.toString());
